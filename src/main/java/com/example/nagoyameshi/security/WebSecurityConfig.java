	...
	public SecurityFilterChain securityFilterChain(HttpSecurity http) throws Exception{
		http
			.authorizeHttpRequests((requests) -> requests
					...
					.requestMatchers("/css/**", "/images/**", "/js/**", "/storage/**", "/" ,"/signup/**", "/houses", "/company/**", "/houses/{id}", "/stripe/webhook","/houses/{id}/reviews/","/houses/*/reviews/**","check-role", "/auth/UserNewPasswordIssue/**", "/auth/UserResetPassword/**", "/auth/reset-password").permitAll()
					// 管理者のみのアクセスを許可するURL
